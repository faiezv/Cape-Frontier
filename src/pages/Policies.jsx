...
const policies = [
  {
    ...
    summary: "Customers should be ready during the specified pickup window.",
    points: [
...

  {
    ...
    summary: "Pickup times may vary depending on the type of transfer booked.",
    points: [
...

  {
    ...
    summary: "Guests must remain reachable on the morning of the tour.",
    points: [
...

  {
    ...
    summary: "Certain tours require stricter pickup times.",
    points: [
...

  {
    ...
    summary: "Some pickup locations may require alternative meeting points.",
    points: [
...

  {
    ...
    summary: "Pickup times may change if operational conditions require it.",
    points: [
...
const Policies = () => {
  ...
  return (
    <>
      <Seo
        title="Policies | Cape Frontier Travel"
        description="Booking, cancellation, and travel policies."
        path="/policies"
      />
      <main
        ref={pageRef}
          ...
          <div className="relative mx-auto max-w-7xl px-5 pb-10 sm:px-6 lg:px-8">
            ...
            <div data-policy-animate className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl font-bitter text-base leading-7 text-neutral-600">
                These are the current provisional Cape Frontier policies for
                booking, pickup, payment, cancellation, rescheduling, private
                tours, and vehicle arrangements. Final operational details
                should still be confirmed by Cape Frontier.
              </p>
            </div>
                ...
                <div className="mt-5 grid gap-3">
                  {policy.points.map((point) => (
                    ...
                    >
                      ...
                      <p className="text-sm leading-6 text-neutral-650">
                        {point}
                      </p>
                    </div>
                  ))}
