...
export const tours = [
  {
    ...
    groupDiscount: {
      ...
      rules: [
        { minPeople: 6, discountPercent: 15 },
      ],
    },
...

  {
    ...
    groupDiscount: {
      ...
      icon: "/icons/savemore.png",
      rules: [
        { minPeople: 3, discountPercent: 3.4 },
      ],
    },
  ...
  {
    id: 12,
    type: TOUR_TYPES.ADRENALINE_ADVENTURE,
    category: TOUR_MODIFIERS.FULL_DAY,
    ...
    description:
      "Combine adrenaline with some of Cape Town's most iconic attractions on this private full-day experience. Begin with a professionally supervised shooting session before exploring Boulders Penguin Colony, Cape Point Nature Reserve, the Cape of Good Hope, and the spectacular Chapman's Peak Drive.",
...

  {
    ...
    images: [
      ...getTourImages(`${ADRENALINE_BASE}/gun-range`, 3),
      ...getTourImages(`${CITY_TOUR_BASE}/bo-kaap`, 2),
      ...getTourImages(`${CITY_TOUR_BASE}/signal-hill`, 2),
      ...getTourImages(`${CITY_TOUR_BASE}/camps-bay`, 2),
      ...getTourImages(`${CITY_TOUR_BASE}/va-waterfront`, 2),
    ],

    destinationGalleries: {
      "gun-range": getTourImages(`${ADRENALINE_BASE}/gun-range`, 3),
      "bo-kaap": getTourImages(`${CITY_TOUR_BASE}/bo-kaap`, 3),
      "signal-hill": getTourImages(`${CITY_TOUR_BASE}/signal-hill`, 3),
      "camps-bay": getTourImages(`${CITY_TOUR_BASE}/camps-bay`, 3),
      waterfront: getTourImages(`${CITY_TOUR_BASE}/va-waterfront`, 3),
    },
    ...
    stops: [
...

      {
        ...
        images: getTourImages(`${CITY_TOUR_BASE}/bo-kaap`, 3),
        touristComments: [
          {
            name: "Emma",
            country: "AU",
...

  {
    ...
    images: [
      ...getTourImages(`${ADRENALINE_BASE}/gun-range`, 3),
      ...getTourImages(`${HIKING_BASE}/noordhoek-beach-horse-riding`, 3),
...

  {
    ...
    images: [
      ...getTourImages(`${ADRENALINE_BASE}/gun-range`, 3),
      ...getTourImages(`${ADRENALINE_BASE}/quad-biking`, 3),
    ],
...

  {
    ...
    image: getCoverImage(`${HIKING_BASE}/noordhoek-beach-horse-riding`),
    ...
    pricing: [
      {
        category: "Per Person",
        pricePerPerson: 3290,
        note: "Includes Robben Island + Langa Township experience",
      },
    ],
...

  {
    id: 19,
    type: TOUR_TYPES.ADRENALINE_ADVENTURE,
    category: TOUR_MODIFIERS.SINGLE_ADVENTURE,
    ...
    image: getCoverImage("adrenaline-adventure/horse-riding-dunes"),
    ...
    pricing: [
      {
        category: "Per Person (2+ guests)",
        pricePerPerson: 2250,
        note: "All-inclusive • Bottled water included",
      },
    ],
